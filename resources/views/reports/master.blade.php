...
@php
    // --- Column Definitions ---
    $export = [
        ['column' => 'invoice_no', 'title' => 'Invoice No'], ['column' => 'invoice_date', 'title' => 'Invoice Date'],
        ['column' => 'consignee_name', 'title' => 'Consignee Name'], ['column' => 'invoice_site', 'title' => 'Invoice Site'],
        ['column' => 'item_name', 'title' => 'Item Name'], ['column' => 'hs_code', 'title' => 'HS Code'],
        ['column' => 'hs_code_second', 'title' => 'HS Code (Second)'], ['column' => 'contract_no', 'title' => 'Contract No'],
        ['column' => 'contract_date', 'title' => 'Contract Date'], ['column' => 'consignee_site', 'title' => 'Consignee Site'],
        ['column' => 'consignee_country', 'title' => 'Consignee Country'], ['column' => 'consignee_address', 'title' => 'Consignee Address'],
        ['column' => 'dst_country_code', 'title' => 'Destination Country Code'], ['column' => 'dst_country_name', 'title' => 'Destination Country Name'],
        ['column' => 'dst_country_port', 'title' => 'Destination Country Port'], ['column' => 'transport_name', 'title' => 'Transport Name'],
        ['column' => 'transport_address', 'title' => 'Transport Address'], ['column' => 'transport_port', 'title' => 'Transport Port'],
        ['column' => 'notify_name', 'title' => 'Notify Name'], ['column' => 'notify_address', 'title' => 'Notify Address'],
        ['column' => 'section', 'title' => 'Section'], ['column' => 'tt_no', 'title' => 'TT No'],
        ['column' => 'tt_date', 'title' => 'TT Date'], ['column' => 'unit', 'title' => 'Unit'],
        ['column' => 'quantity', 'title' => 'Quantity'], ['column' => 'currency', 'title' => 'Currency'],
        ['column' => 'amount', 'title' => 'Amount'], ['column' => 'cm_percentage', 'title' => 'CM %'],
        ['column' => 'incoterm', 'title' => 'Incoterm'], ['column' => 'cm_amount', 'title' => 'CM Amount'],
        ['column' => 'freight_value', 'title' => 'Freight Value'], ['column' => 'exp_no', 'title' => 'Export No'],
        ['column' => 'exp_date', 'title' => 'Export Date'], ['column' => 'exp_permit_no', 'title' => 'Export Permit No'],
        ['column' => 'bl_no', 'title' => 'BL No'], ['column' => 'bl_date', 'title' => 'BL Date'],
        ['column' => 'ex_factory_date', 'title' => 'Ex-Factory Date'], ['column' => 'net_wet', 'title' => 'Net Weight'],
        ['column' => 'gross_wet', 'title' => 'Gross Weight'], ['column' => 'create_by', 'title' => 'Created By'],
