        ...
        <div class="card-title">
                ...
                <div class="row ">
                    <div class="col-6 ">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="receivable_amount"  class="form-control" id="receivable_amount" placeholder="Receivable Amount" value="{{ old('receivable_amount') }}" />
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                                <input type="text" name="doc_process_fee" class="form-control" id="doc_process_fee" placeholder="Doc Process Fee" value="{{ old('doc_process_fee') }}" />
                            </div>
                        </div>
            ...
            <div class="col-6">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="seal_lock_charge" class="form-control" id="seal_lock_charge" placeholder="Seal Lock Charge" value="{{ old('seal_lock_charge') }}" />
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="agency_commission" class="form-control" id="agency_commission" placeholder="Agency Commission" value="{{ old('agency_commission') }}" />
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="documentation_charge" class="form-control" id="documentation_charge" placeholder="Documentation Charge" value="{{ old('documentation_charge') }}" />
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="transportation_charge" class="form-control" id="transportation_charge" placeholder="Transportation Charge" value="{{ old('transportation_charge') }}" />
                    </div>
                </div>
            ...
            <div class="col-6">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="short_shipment_certificate_fee" class="form-control" id="short_shipment_certificate_fee" placeholder="Short Shipment Certificate Fee" value="{{ old('short_shipment_certificate_fee') }}" />
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="factory_loading_fee" class="form-control" id="factory_loading_fee" placeholder="Factory Loading Fee" value="{{ old('factory_loading_fee') }}" />
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="uploading_fee_forwarder_wh" class="form-control" id="uploading_fee_forwarder_wh" placeholder="Uploading Fee Forwarder WH" value="{{ old('uploading_fee_forwarder_wh') }}" />
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="truck_demurrage_fee_delay_at_depot" class="form-control" id="truck_demurrage_fee_delay_at_depot" placeholder="Truck Demurrage Fee Delay at Depot" value="{{ old('truck_demurrage_fee_delay_at_depot') }}" />
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="cfs_depot_mixed_cargo_loading_fee" class="form-control" id="cfs_depot_mixed_cargo_loading_fee" placeholder="CFS Depot Mixed Cargo Loading Fee" value="{{ old('cfs_depot_mixed_cargo_loading_fee') }}" />
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="customs_misc_remark_reasons_charge" class="form-control" id="customs_misc_remark_reasons_charge" placeholder="Customs Misc Remark Reasons Charge" value="{{ old('customs_misc_remark_reasons_charge') }}" />
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="customs_remark_charge_misc_reasons" class="form-control" id="customs_remark_charge_misc_reasons" placeholder="Customs Remark Charge Misc Reasons" value="{{ old('customs_remark_charge_misc_reasons') }}" />
                    </div>
                </div>
            ...
            <div class="col-6">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="date" name="cargo_ho_date" class="form-control" id="cargo_ho_date" placeholder="Cargo HO Date" value="{{ old('cargo_ho_date') }}" />
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="date" name="deadline_bill_submission" class="form-control" id="deadline_bill_submission" placeholder="Deadline for Bill Submission" value="{{ old('deadline_bill_submission') }}" />
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="date" name="bill_received_date" class="form-control" id="bill_received_date" placeholder="Bill Received Date" value="{{ old('bill_received_date') }}" />
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" name="forwarder_name" class="form-control" id="forwarder_name" placeholder="Forwarder Name" value="{{ old('forwarder_name') }}" />
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" readonly name="total_charges" class="form-control" id="total_charges" placeholder="Total Charges" value="{{ old('total_charges') }}" />
                    </div>
                </div>
